...
// 슬라이드 개수를 직접 넣지말고
// JS가 알아서 개수를 파악하게 해야한다!
const SLIDE_NUM = $slide.find('li').length;
console.log('슬라이드 개수',SLIDE_NUM);
...
//블릿 현재 순번 li에 class on넣기,나머지 클래스는 제거
