...
/* 요구사항 정리
    ...
    -> 클래스 on을 이미지에 주면 오른쪽 바깥쪽으로 이미지를 이동
    3. 이 때 이미지를 변경함
    4. 이미지가 변경된 후 중앙으로 등장
    -> 클래스 on을 제거하면 중앙으로 등장 
    */
...
// querySelector가 아니면 아래처럼 많이 복잡하게 써야함
// ex)
// // ㅎㅎㅎ = document
