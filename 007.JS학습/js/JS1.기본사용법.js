...
function 움직여랏(나야나, 이동값, 동영상아이디) {
  ...
  //1. 함수호출확인 및 전달변수값 확인////////////////////////////////////
  console.log("당장움직여",나야나, 이동값, 동영상아이디
  );
  ...
  //가져와get요소들을Elements태그이름으로ByTagName
  //-> 태그요소도 여러개 사용하므로 순번선택 필수! item(순번)
...
//  글자관련 CSS추가하기
 나야나.style.fontSize = '80px';
 나야나.style.color ='aquamarine';
 나야나.style.lineHeight ='100vh';
//  -> 100vh 단위는 보이는 화면의 실제 높이값을 가져옴
